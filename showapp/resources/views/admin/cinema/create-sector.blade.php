    ...
    <div class="sector-size">
        <div class="masonary-grids">
            <div class="col-md-12">
                ...
                <form method="post" action="{{action('SectorController@create')}}">
                    ...
                    <input type="hidden" id="hallId" name="hallId" value="{{$hall->id}}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#createSector').on('click', function () {
                ...
                $.post("{{asset('/create-sector')}}", {placeData: placeData, column: column, row: row, name: $('#sectorName').val(), price: $('#sectorPrice').val(), hallId: hallId, color: $('#color').val() }, function (response) {

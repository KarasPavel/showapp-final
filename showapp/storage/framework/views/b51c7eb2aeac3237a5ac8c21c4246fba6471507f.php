...
<div class="first-screen-wrapper">
                    ...
                    <div class="clip-wrap">
                        <div class="content-wrap">
                            ...
                            <div class="first-screen-footer">
                                <p class="age"><?php echo e($event->ageRestrictions); ?></p>
                                <h1><?php echo e($event->title); ?></h1>
                                <div class="buton btns">
                                    <i></i>
                                    <a href="<?php echo e('event/' . $event->id); ?>">DETAILS</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="drag-wrap" style="display: none">
        ...
        <div class="scale">
            ...
            <div class="line"></div>
            <div class="arrow-btn">
                <img src="<?php echo e(asset('img/pics/drag-arrow.png')); ?>" alt="">
            </div>
        </div>
    </div>
</div>
<div class="wrapper-stick" id="wrapper-stick">
                            ...
                            <li>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="drope-element">
                                        ...
                                        <input type="hidden" value="<?php echo e($category->id); ?>">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </li>
                        </ul>
    ...
    <div class="stick-w" id="stick-w">
        ...
        <?php $__currentLoopData = $allEvent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a class="stick-item" href="event/<?php echo e($event->id); ?>">
                <div class="event">
                    <div class="stick-img">
                        ...
                        <?php if(isset($event->coverImage) && !empty($event->coverImage)): ?>
                            <?php if(strpos($event->coverImage, 'https://') !== false): ?>
                                <img src="<?php echo e(asset($event->coverImage)); ?>">
                            <?php else: ?>
                    ...
                    <div class="date">
                        <p><?php echo e(date('M. d, Y',strtotime($event->dateStart))); ?></p>
                    </div>
    ...
    <?php echo e($allEvent->render()); ?>

</div>
<div class="phone-wrap">
    <div class="caption-wrap">
        <div class="iphon">
            <img class="circle" src="<?php echo e(asset('img/pics/2-layers.png')); ?>" alt="">
            <div class="slider-border"></div>
            <div class="slider">
                <div class="slider-item">
                    <img src="<?php echo e(asset('img/pics/slid.jpg')); ?>" alt="">
                </div>
                <div class="slider-item">
                    <img src="<?php echo e(asset('img/pics/slid2.jpg')); ?>" alt="">
                </div>
                <div class="slider-item">
                    <img src="<?php echo e(asset('img/pics/slid.jpg')); ?>" alt="">
                </div>
        ...
        <div class="btn">
            <div class="half-of-button">
                <img src="<?php echo e(asset('img/pics/apple.svg')); ?>" alt="">
                <p>Download on the </p>
                <h1>App Store</h1>
            </div>
            <div class="half-of-button right-part">
                <img src="<?php echo e(asset('img/pics/google.svg')); ?>" alt="">
                <p>GET IN ON</p>
                <h1>Google Play</h1>
            </div>
        </div>
...
<div class="about-showapp-wrap">
    ...
    <div class="social-item-wrap">
        <div class="social-wrap">
            ...
            <div class="content">
                <img class="back" src="<?php echo e(asset('img/pics/showapp-fb.png')); ?>" alt="">
                <div class="logo">
                    <img src="<?php echo e(asset('img/pics/show-app.svg')); ?>" alt="">
                </div>
                <div class="likes">
                ...
                <div class="btn">
                    <div class="img-wrapper">
                        <img src="<?php echo e(asset('img/pics/forma-1.svg')); ?>" alt="">
                    </div>
                    <p>Follow</p>
                </div>
            </div>
        ...
        <div class="social-wrap">
            ...
            <div class="content inst">
                ...
                <img class="back" src="<?php echo e(asset('img/pics/about-showapp-inst.png')); ?>" alt="">
                <div class="logo">
                    <img src="<?php echo e(asset('img/pics/show-app.svg')); ?>" alt="">
                </div>
                <div class="likes">
                ...
                <a href="">
                    <img src="<?php echo e(asset('img/pics/inst-link-1.png')); ?>" alt="">
                </a>
                <a href="">
                    <img src="<?php echo e(asset('img/pics/inst-link-2.png')); ?>" alt="">
                </a>
                <a href="">
                    <img src="<?php echo e(asset('img/pics/inst-link-3.png')); ?>" alt="">
                </a>
                <div class="btn">
                    <p>Follow</p>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.drope-element').on('click', function() {
            ...
            sort = id;
            address = "<?php echo e(asset('sorting-events')); ?>";
            $.post(address, {
                data: sort
            }, function(response) {
                if (response != 'false') {
        ...
        $('.datepicker-start').datepicker({
            ...
            onSelect: function(date, cellType) {
                ...
                address = "<?php echo e(asset('sorting-events-by-date')); ?>";
                $.post(address, {
                    data: sort
                }, function(response) {
                    if (response != 'false') {

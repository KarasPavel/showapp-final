...
<div class="first-screen-wrapper">
    <div class="menu">
        ...
        <div class="right-part-menu column-menu">
            <div class="element search el" id="element-search-el">
                <img src="img/pics/search.svg" alt="">
            </div>
        ...
        <div class="burger-part-menu el">
            <div class="w-burg-p">
                <div class="wrap-mobile-leng">
                    <div class="element language">
                        <p>EN</p>
                        <div class="arrow">
                            <img src="img/pics/arrow-down.png" alt="">
                        </div>
                    </div>
                </div>
                <?php if(!Auth::user()): ?>
            ...
            <!--<div class="menu-item">
                    <a href="<?php echo e(route('buy-ticket')); ?>">Buy ticket</a>
                </div>-->
                <div class="menu-item">
    ...
    <div class="drag-wrap" style="display: none">
        ...
        <div class="scale">
            ...
            <div class="line"></div>
            <div class="arrow-btn">
                <img src="img/pics/drag-arrow.png" alt="">
            </div>
        </div>
    </div>
</div>
...
<div class="phone-wrap">
    <div class="caption-wrap">
        <div class="iphon">
            <img class="circle" src="img/pics/2-layers.png" alt="">
            <div class="slider-border"></div>
            <div class="slider">
                <div class="slider-item">
                    <img src="img/pics/slid.jpg" alt="">
                </div>
                <div class="slider-item">
                    <img src="img/pics/slid2.jpg" alt="">
                </div>
                <div class="slider-item">
                    <img src="img/pics/slid.jpg" alt="">
                </div>
        ...
        <div class="btn">
            <div class="half-of-button">
                <img src="img/pics/apple.svg" alt="">
                <p>Download on the </p>
                <h1>App Store</h1>
            </div>
            <div class="half-of-button right-part">
                <img src="img/pics/google.svg" alt="">
                <p>GET IN ON</p>
                <h1>Google Play</h1>
            </div>
        </div>
...
<div class="about-showapp-wrap">
    ...
    <div class="social-item-wrap">
        <div class="social-wrap">
            ...
            <div class="content">
                <img class="back" src="img/pics/showapp-fb.png" alt="">
                <div class="logo">
                    <img src="img/pics/show-app.svg" alt="">
                </div>
                <div class="likes">
                ...
                <a href="">
                    <img src="img/pics/fb-link-1.png" alt="">
                </a>
                <a href="">
                    <img src="img/pics/fb-link-2.png" alt="">
                </a>
                <a href="">
                    <img src="img/pics/fb-link-3.png" alt="">
                </a>
                <a href="">
                    <img src="img/pics/fb-link-4.png" alt="">
                </a>
                <div class="btn">
                    <div class="img-wrapper">
                        <img src="img/pics/forma-1.svg" alt="">
                    </div>
                    <p>Follow</p>
                </div>
            </div>
        ...
        <div class="social-wrap">
            ...
            <div class="content inst">
                ...
                <img class="back" src="img/pics/about-showapp-inst.png" alt="">
                <div class="logo">
                    <img src="img/pics/show-app.svg" alt="">
                </div>
                <div class="likes">
                ...
                <a href="">
                    <img src="img/pics/inst-link-1.png" alt="">
                </a>
                <a href="">
                    <img src="img/pics/inst-link-2.png" alt="">
                </a>
                <a href="">
                    <img src="img/pics/inst-link-3.png" alt="">
                </a>
                <div class="btn">
                    <p>Follow</p>
                </div>
